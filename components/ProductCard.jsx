...
const ProductCard = ({ product }) => {
    ...
    return (
        <div
            ...
            role="link"
            tabIndex={0}
            className="flex flex-col items-start gap-0.5 max-w-[200px] w-full cursor-pointer focus-visible:ring-2 focus-visible:ring-orange-600 outline-none rounded-lg"
        >
